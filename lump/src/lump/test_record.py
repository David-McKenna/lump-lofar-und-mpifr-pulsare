...
def main():
    ...
    p.add_argument("--station_name",default="Ef",type=str,choices=["Ef", "Uw", "Tb", "Po", "Ju", "Nc", "On", "Cb", "Nd", "Br", "DE601","DE602","DE603","DE604","DE605","FR606","SE607","UK608","DE609", "IE613"],help="LOFAR name of the station dumping data to this writer.  Defaults to %(default)s")
